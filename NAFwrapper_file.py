...
# This is a wrapper for the entity typing system. It assumes a text in NAF format with 
# at least an entity layer. It reads the entities from that layer and adds entity type 
# information 
